 ...
 */
SURFBrowser.prototype.insertTimeCard = function(timeCard, callBackFunction) {
    new Horseman()
        .userAgent("Mozilla/5.0 (Windows NT 6.1; WOW64; rv:27.0) Gecko/20100101 Firefox/27.0")
        .viewport(1980,1080)
        ...
        .type("#sys_display\\.time_card\\.u_account", timeCard.account)
        .wait(2000)
        .click("#sys_display\\.time_card\\.task")
        .type("#sys_display\\.time_card\\.task", timeCard.deployment)
        .wait(1000)
        .click("#sys_display\\.time_card\\.u_billing_rate")
        .type("#sys_display\\.time_card\\.u_billing_rate", timeCard.resourcePlan)
        .wait(1000)
